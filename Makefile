...
algo: compression/huffman.o compression/lz77.o compression/lz78.o \
      ...
      data_structures/heap.o data_structures/tree.o data_structures/hash_table.o data_structures/graph.o \
      ...
      geometry/geometry.o geometry/point.o geometry/line_string.o geometry/polygon.o geometry/wkb_reader.o \
